...
export const InstanceCard = memo(function InstanceCard({ instance, allInstances }: InstanceCardProps) {
  ...
  return (
    <>
      <Card className="bg-card/50 backdrop-blur-sm border-border/50 hover:border-primary/40 transition-all duration-300 group overflow-hidden max-w-[350px] min-h-[220px]">
