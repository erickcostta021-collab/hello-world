...
export const InstanceCard = memo(function InstanceCard({ instance, allInstances }: InstanceCardProps) {
  ...
  return (
    <>
      <Card className="bg-card/50 backdrop-blur-sm border-border/50 hover:border-primary/40 transition-all duration-300 group overflow-hidden max-w-[350px] min-h-[220px] rounded-sm">
          ...
          <div className="px-4 pb-4 flex items-center justify-center">
            {isConnected ? (
              <Button
                ...
                className="bg-red-900 text-white hover:bg-red-800 h-auto py-1.5 px-3 text-xs uppercase tracking-wider font-bold rounded-sm border-none w-auto"
              >
                Desconectar
              </Button>
            ) : (
