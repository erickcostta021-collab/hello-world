...
export function ManageMessagesDialog({ open, onOpenChange, instance, allInstances, embedToken, trackId: propTrackId }: ManageMessagesDialogProps) {
  ...
  const renderAntiBan = () => (
    <div className="space-y-3 p-3 rounded-lg border border-primary/40 hover:border-primary/70 transition-colors bg-secondary/30">
      <div className="flex items-center justify-between">
              ...
              <div className="space-y-4">
                ...
                <Card className="bg-secondary/20 border-primary/40 hover:border-primary/70 transition-colors">
                  <CardContent className="p-4 space-y-3">
                    ...
                    <div className="p-2.5 rounded-lg border border-primary/40 hover:border-primary/70 transition-colors bg-secondary/30 space-y-2">
                      <div className="flex items-center justify-between">
