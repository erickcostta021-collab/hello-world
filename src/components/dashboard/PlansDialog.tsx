          ...
          <div className="grid gap-4 md:grid-cols-3 pt-4">
            {PLANS.map((plan) => {
              ...
              const price = isFlexible
                ? (flexibleQuantity <= 4 ? 29 + 10 * (flexibleQuantity - 1) * flexibleQuantity / 2 : 89 + 25 * (flexibleQuantity - 4))
                : plan.price!;
              ...
              return (
                ...
                >
                  ...
                  {isFlexible && (
                    <div className="mb-4">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-sm font-bold text-primary">{flexibleQuantity}</span>
                      </div>
                      <Slider
                  ...
                  <Button
                    onClick={() =>
                      handleSelectPlan(plan.key, isFlexible ? flexibleQuantity : undefined)
                    }
                    className={cn(
                      "w-full",
                      plan.popular
