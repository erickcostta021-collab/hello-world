...
const LandingPage = () => {
  ...
  const totalPrice = FLEXIBLE_PRICES[instanceCount];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8">
            ...
            <div className="group bg-card rounded-2xl p-8 border border-border hover:border-brand-blue hover:scale-[1.02] hover:-translate-y-1 transition-all duration-300 flex flex-col">
              ...
              <div className="mb-4">
                ...
                <p className="text-sm text-brand-green font-medium mt-1">
                  {instanceCount === 1 ? formatPerUnit(29) : formatPerUnit(25)}
                </p>
                {instanceCount <= 2 && (
            ...
            <div className="group bg-card rounded-2xl p-8 border border-border hover:border-brand-blue hover:scale-[1.02] hover:-translate-y-1 transition-all duration-300 flex flex-col">
              ...
              <div className="mb-2">
                <span className="text-4xl font-bold text-foreground transition-opacity duration-300"><span className="text-4xl font-bold text-foreground transition-opacity duration-300">{formatPrice(898)}</span></span>
                <span className="text-muted-foreground">/mês</span>
              </div>
